...
import { AddEditEmp } from './add-edit-emp/add-edit-emp';
...
@Component({
  ...
  templateUrl: './employeemaster.html',
  styleUrl: './employeemaster.scss'
})
export class Employeemaster {
   private readonly translate = inject(TranslateService);
    ...
    openAddDialog() {
      const dialogRef = this.dialog.open(AddEditEmp, {
        width: '100%',
        height: '100%',
        maxWidth: '100vw',
        maxHeight: '100vh',
