...
export class Statemaster implements OnInit {
  ...
  constructor(private fb: FormBuilder,private stateService: Stateservice,private dialog: MatDialog,private toastService:Toastservice) {}
    ngOnInit(): void {
     this.loadAllState();
   }
 ...
 openAddDialog() {
  ...
  dialogRef.afterClosed().subscribe(result => {
    ...
    if (result) {
      ...
      this.toastService.showError('Failed to add state. Please verify state details and try again.');
    }
        }
      });
    }
