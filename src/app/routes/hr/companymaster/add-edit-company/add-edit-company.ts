...
export class AddEditCompany {
  ...
  private initializeForm(): void {
    ...
    this.companyForm = this.fb.group({
      ...
      // Basic Information
     // CompanyCode: ['', [Validators.required, Validators.maxLength(20)]],
       CompanyCode: [
      {
      ...
      // AI & Analytics
      AIInsightsEnabled: [false, [Validators.required]],
      PredictiveAnalyticsLevel: ['Basic', [Validators.required, Validators.maxLength(20)]],
      InterCompanyTransactions: [false, [Validators.required]],
      LocationAdvantageScore: ['', [Validators.min(0), Validators.max(10)]],
      TalentAccessibilityScore: ['', [Validators.min(0), Validators.max(10)]],
      CostEfficiencyRating: ['', [Validators.min(0), Validators.max(10)]],

      // Additional Information
      CompanyRemark: ['', [Validators.required, Validators.maxLength(200)]],
    ...
    if (this.isEditMode) {
      ...
      console.log('Patching form with company data:', this.data.company);
       ...
       const establishedDate = companyData.EstablishedDate ? new Date(companyData.EstablishedDate) : '';
       const fiscalYearStart = companyData.FiscalYearStart ? new Date(companyData.FiscalYearStart) : '';
      ...
      this.companyForm.patchValue({
       ...
       // CompanyMasterEntityTypeId: companyData.CompanyMasterEntityTypeId || '',
  ...
  //   const parentCompanyData = this.data.parentCompany;
  //   // Find currency by name (trim whitespace for comparison)
  //   if (parentCompanyData?.CompanyEntityTypeName) {
  //     const compEntityType = this.parentcompanyList.find(
  //       c => c.ParentCompanyName.trim() === parentCompanyData.ParentCompanyName.trim()
  //     );
  //     parentCompId = compEntityType ? compEntityType.companyEntityTypeId : null;
  //     console.log( 'Found currency by name:', parentCompId,'for currency:',
  ...
  //   if (parentCompId) {
  //     this.companyForm.patchValue({
  //       CompEntityTypeId: parentCompId,
  //     });
  //     console.log('Currency set in form:', parentCompId);
  //   } else {
  //     console.log(
  //       'No parent company id found for parent company name:',
  //       parentCompanyData?.CompanyEntityTypeName
  //     );
  //   }
  // }
  ...
  private setCorporateCountryForEdit(): void {
    ...
    if (corporateCountryId) {
      ...
      console.log('No Corporate Country ID found for Corporate Country name:', countryData?.CorporateCountryName);
    }
  }
  ...
  private setCorporateStateForEdit(): void {
    ...
    if (stateData?.CorporateStateName) {
      ...
      console.log('Found state by name:', corporateStateId, 'for state:', stateData.CorporateStateName);
    }
    if (corporateStateId) {
      this.companyForm.patchValue({
      ...
      console.log('No Corporate State ID found for Corporate State name:', stateData?.CorporateStateName);
    }
  }
  ...
  private setCorporateDistrictForEdit(): void {
    ...
    if (corporateDistrictId) {
      ...
      console.log('No Corporate District ID found for Corporate District name:', districtData?.CorporateDistrictName);
    }
  }
  ...
  private setCorporateCityForEdit(): void {
    ...
    if (corporateCityId) {
      ...
      console.log('No Corporate City ID found for Corporate City name:', cityData?.CorporateCityName);
    }
  }
