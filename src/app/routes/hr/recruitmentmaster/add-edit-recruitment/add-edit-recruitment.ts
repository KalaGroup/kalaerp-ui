...
export class AddEditRecruitment implements OnInit {
  ...
  private initializeForm(): void {
    ...
    this.RecruitmentForm = this.fb.group({
      ...
      RecruitmentMasterPositionId: [''],
      RecruitmentMasterCode: ['', Validators.required],
      ...
      RecruitmentMasterCityId: [''],
      RecruitmentMasterCompanyId: [''],
      ...
      RecruitmentMasterInterviewerEmployeeId: [''],
      RecruitmentMasterInterviewerComment: [''],
      RecruitmentMasterGradeId: [''],
      RecruitmentMasterDesignationId: [''],
      ...
      RecruitmentMasterRecruitmentStageStatusId: [''],
